...
class PWCNet(torch.nn.Module):
    ...
    def forward(self, tensorFirst, tensorSecond):
        ...
        # print("W: ",intWidth,intPreprocessedWidth)
        # print("H: ",intHeight,intPreprocessedHeight)
    ...
    def forward_pre(self, tensorFirst, tensorSecond):
        ...
        #print("In PWCNET FLOW SHAPE: ",(objectEstimate['tensorFlow'] + self.moduleRefiner(objectEstimate['tensorFeat'])).shape)
